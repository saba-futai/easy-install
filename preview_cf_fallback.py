...
# Preview the Cloudflare-style 500 page that the installer deploys.
# Based on: https://github.com/donlon/cloudflare-error-page (MIT)
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Preview the Cloudflare-style 500 fallback page on localhost.")
    parser.add_argument("--bind", default="127.0.0.1")
    parser.add_argument("--port", type=int, default=18080)
    parser.add_argument("--params", default="", help="Optional JSON file path to override parameters.")
    ...
    print(f"Listening on http://{args.bind}:{args.port}/ (always returns HTTP 500). Ctrl+C to stop.")
